...
**Status:** Complete. Final regression model: XGBoost v3 tuned (31 features, +GARCH D-1 lag, post-Uri 2021–2024 window). Test R²=0.393, RMSE=0.665, MAE=4.033 $/MWh (2025 holdout). Best spike classifier: XGB-slim (6 features), CV PR-AUC=0.459, CV F1=0.497; test PR-AUC=0.297, F1=0.385.
